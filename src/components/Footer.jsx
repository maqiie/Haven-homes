        ...
        <div className="footer-brand">
          <div className="footer-brand-inner">
            <Link to="/" style={{ textDecoration: 'none', display: 'inline-flex', alignItems: 'baseline', gap: 6, marginBottom: 24 }}>
              ...
              <span className="footer-logo-sub" style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 9, fontWeight: 400, letterSpacing: '0.28em', textTransform: 'uppercase', color: '#8B7355' }}>Homes</span>
            </Link>
