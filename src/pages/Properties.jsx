...
const LAND_LISTINGS = [
  {
    name: "Kiambu",
    address: "Kiambu, Kiambu County",
    featured: false,
    coordinates: { lat: -1.17, lng: 36.835 },
    description:
      "Prime land in Kiambu, one of Nairobi's fastest-growing satellite towns. Excellent infrastructure, schools, and amenities nearby.",
  },
  {
    name: "Kitusuru",
    address: "Kitusuru, Nairobi",
    featured: false,
    coordinates: { lat: -1.23, lng: 36.79 },
    description:
      "Serene and leafy Kitusuru, bordering Runda. Quiet, secure environment with easy access to Westlands and the UN area.",
  },
  {
    name: "Karen",
    address: "Karen, Nairobi",
    featured: true,
    coordinates: { lat: -1.35, lng: 36.71 },
    description:
      "Nairobi's most prestigious low-density suburb. Wide open spaces, top international schools, and an unmatched tranquil lifestyle.",
  },
  {
    name: "Loresho",
    address: "Loresho, Nairobi",
    featured: false,
    coordinates: { lat: -1.253, lng: 36.778 },
    description:
      "One of Nairobi's most established neighbourhoods. Known for generous plot sizes, mature trees, and proximity to Westlands.",
  },
  {
    name: "Lavington",
    address: "Lavington, Nairobi",
    featured: true,
    coordinates: { lat: -1.278, lng: 36.787 },
    description:
      "Highly desirable mid-to-high end suburb with excellent connectivity to Westlands, the CBD, top schools, hospitals, and shopping.",
  },
  {
    name: "Lower Kabete",
    address: "Lower Kabete, Nairobi",
    featured: false,
    coordinates: { lat: -1.248, lng: 36.75 },
    description:
      "Rapidly appreciating area on the outskirts of Nairobi with strong capital growth potential and easy access to Waiyaki Way.",
  },
  {
    name: "Westlands",
    address: "Westlands, Nairobi",
    featured: true,
    coordinates: { lat: -1.2676, lng: 36.807 },
    description:
      "Nairobi's premier commercial and upscale residential hub. Unmatched connectivity and strong rental and development returns.",
  },
  {
    name: "Ruiru",
    address: "Ruiru, Kiambu County",
    featured: false,
    coordinates: { lat: -1.147, lng: 36.961 },
    description:
      "Affordable entry point in one of Nairobi's fastest-growing satellite towns along the Thika Superhighway corridor.",
  },
  {
    name: "Diani",
    address: "Diani, Kwale County, Coast",
    featured: true,
    coordinates: { lat: -4.28, lng: 39.59 },
    description:
      "Kenya's most celebrated beach destination on the South Coast. Exceptional investment potential driven by tourism and Airbnb demand.",
  },
  {
    name: "Runda",
    ...
    description:
      "Nairobi's most exclusive residential address. Exceptionally scarce land in a neighbourhood favoured by diplomats and executives.",
  },
].map((loc, i) => ({
  id: 1000 + i,
  ...
  <div style={{ position: "relative", ...style }}>
    <select
      ...
      style={{
        ...
        background:
          value !== "all" && value !== "" ? "rgba(139,115,85,0.05)" : "#fff",
...
const LandPlaceholder = ({ location }) => (
  <div
    style={{
      ...
      height: "100%",
      background:
        "linear-gradient(135deg, #1a1a17 0%, #2a2720 50%, #1e1c19 100%)",
      display: "flex",
  ...
  >
    ...
    >
      <defs>
        ...
        >
          ...
          />
          <path
            d="M0 30 Q10 20 20 30 Q30 40 40 30"
            fill="none"
            stroke="#8B7355"
            strokeWidth="0.5"
          />
    ...
    <div
      style={{
        ...
        inset: 0,
        background:
          "radial-gradient(ellipse 60% 60% at 50% 50%, rgba(139,115,85,0.14) 0%, transparent 70%)",
        pointerEvents: "none",
      }}
      aria-hidden="true"
    />
    ...
    <svg
      ...
      viewBox="0 0 24 24"
      fill="none"
      style={{ color: "#8B7355", marginBottom: 12, flexShrink: 0 }}
      aria-hidden="true"
    >
      <path
        fillRule="evenodd"
...
const Properties = () => {
  ...
  const forSaleCount = useMemo(
    () =>
      allProperties.filter(
        (p) => p.type === "for-sale" && p.propertyType !== "land",
      ).length,
    [allProperties],
  );
  const forRentCount = useMemo(
    () => allProperties.filter((p) => p.type === "for-rent").length,
    [allProperties],
  );
  const landCount = useMemo(
    () => allProperties.filter((p) => p.propertyType === "land").length,
    [allProperties],
  );
    ...
    const filtered = allProperties.filter((p) => {
      ...
      const matchListing =
        filters.listingType === "all"
          ? p.propertyType !== "land"
          : filters.listingType === "land"
            ? p.propertyType === "land"
            : filters.listingType === "for-sale"
              ? p.type === "for-sale" && p.propertyType !== "land"
  ...
  const locationLabel = (p) =>
    p.location === "Diani" ? `${p.location}, Coast` : `${p.location}, Nairobi`;
    ...
    >
      ...
      >
        <div
          style={{
            ...
            inset: 0,
            background:
              "radial-gradient(ellipse 60% 70% at 75% 40%, rgba(139,115,85,0.18) 0%, transparent 65%)",
            pointerEvents: "none",
          }}
          aria-hidden="true"
        />
        <div
          style={{
            ...
            height: 1,
            background:
              "linear-gradient(to right, transparent, rgba(139,115,85,0.4), transparent)",
          }}
          aria-hidden="true"
        />
        <div
        ...
        >
          <div>
            ...
            >
              <div
                style={{ width: 28, height: 1, background: "#8B7355" }}
                aria-hidden="true"
              />
              <span
                style={{
            ...
            >
              Nairobi's finest homes — from off-plan investments to
              ready-to-move-in residences.
            </p>
          </div>
          <div
          ...
          >
            {[
              {
                n: allProperties.filter((p) => p.propertyType !== "land")
                  .length,
                l: "Total Listings",
              },
      ...
      >
        ...
        >
          {[
            {
              ...
              val: "all",
              count: allProperties.filter((p) => p.propertyType !== "land")
                .length,
            },
            ...
            return (
              <button
                key={tab.val}
                onClick={() => setFilter("listingType", tab.val)}
                style={{
                  display: "flex",
                  alignItems: "center",
                  gap: 8,
          ...
          >
            {allProperties.length} listings across{" "}
            {[...new Set(allProperties.map((p) => p.location))].length}{" "}
            locations
          </span>
        </div>
      </div>
      ...
      >
        <div
          ...
          style={{ maxWidth: 1400, margin: "0 auto", padding: "16px 6vw" }}
        >
          {/* Search */}
          <div style={{ position: "relative", marginBottom: 12 }}>
            ...
            <input
              ...
              onFocus={(e) => {
                ...
                e.currentTarget.style.background = "rgba(139,115,85,0.04)";
              }}
              onBlur={(e) => {
                if (!e.currentTarget.value) {
                  e.currentTarget.style.borderColor = "#E2DED9";
          ...
          >
                ...
                <>
                  ...
                  {filters.bedrooms !== "all" && (
                    ...
                    >
                      ...
                      <button
                        onClick={() => setFilter("bedrooms", "all")}
                        style={{
                          background: "none",
                          border: "none",
                          cursor: "pointer",
            ...
            >
              {[
                ...
                <button
                  key={mode}
                  className={`vtog${viewMode === mode ? " vtog-active" : ""}`}
      ...
      >
        <p style={{ fontSize: 12, color: "#aaa", letterSpacing: "0.06em" }}>
          ...
          {hasActiveFilter && (
            <em style={{ color: "#8B7355", fontStyle: "normal" }}>
              {" "}
              — filtered
            </em>
          )}
                    ...
                    >
                      ...
                      <div
                        style={{
                          ...
                          height: 272,
                          overflow: "hidden",
                          background: isLand ? "#1a1a17" : "#F0EDE8",
                        }}
                      >
                        ...
                        <div
                          ...
                          style={{
                            ...
                            inset: 0,
                            background:
                              "linear-gradient(to top, rgba(15,14,12,0.72) 0%, transparent 55%)",
                          }}
                          aria-hidden="true"
                        />
                          ...
                          >
                            {isLand ? (
                              <>
                                ...
                                <span
                                  style={{ color: "#8B7355", fontSize: 11 }}
                                >
                                  Multiple plot sizes available
                                </span>
                              </>
