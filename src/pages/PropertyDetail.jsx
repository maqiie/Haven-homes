        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              {/* Payment Plan — shown only if property has one */}
              {property.paymentPlan && (
                <div>
                  <h2 className="text-2xl font-serif text-neutral-900 mb-6">Payment Plan</h2>
                  <div className="grid grid-cols-3 gap-6">
                    <div className="bg-white border border-neutral-200 p-6 text-center">
                      <p className="text-3xl font-light text-neutral-900 mb-1">{property.paymentPlan.downPayment}</p>
                      <p className="text-sm text-neutral-500 uppercase tracking-wider">Down Payment</p>
                    </div>
                    <div className="bg-white border border-neutral-200 p-6 text-center">
                      <p className="text-3xl font-light text-neutral-900 mb-1">{property.paymentPlan.quarterly}</p>
                      <p className="text-sm text-neutral-500 uppercase tracking-wider">Quarterly</p>
                    </div>
                    <div className="bg-white border border-neutral-200 p-6 text-center">
                      <p className="text-3xl font-light text-neutral-900 mb-1">{property.paymentPlan.duration}</p>
                      <p className="text-sm text-neutral-500 uppercase tracking-wider">Duration</p>
                    </div>
                  </div>
                  {property.completionDate && (
                    <p className="mt-4 text-neutral-600">
                      <span className="font-medium">Completion Date:</span> {property.completionDate}
                    </p>
                  )}
                </div>
              )}
                  ...
                  {property.priceRange && (
                    <div className="flex justify-between py-3 border-b border-neutral-200">
                      ...
                      <span className="text-neutral-900 font-medium">
                        KSh {property.priceRange.min.toLocaleString()} – {property.priceRange.max.toLocaleString()}
                      </span>
                    </div>
                  )}
                </div>
              ...
              {/* Brochure Download — shown only if property has one */}
              {property.brochure && (
                <div>
                  <h2 className="text-2xl font-serif text-neutral-900 mb-4">Downloads</h2>
                  <a
                    href={property.brochure}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-3 px-6 py-4 bg-neutral-900 text-white hover:bg-neutral-800 transition-colors"
                  >
              ...
              <div className="sticky top-24">
                <div className="bg-white border border-neutral-200 p-8">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                      <label className="block text-sm text-neutral-700 mb-2 font-medium">Email Address *</label>
                      <input
                        type="email"
                        name="email"
                    ...
                    <div>
                      <label className="block text-sm text-neutral-700 mb-2 font-medium">Message *</label>
                      <textarea
                        name="message"
      ...
      <section className="py-16 bg-white border-t border-neutral-200">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {properties.filter(p => p.id !== property.id).slice(0, 3).map((similarProp) => (
              <Link
                key={similarProp.id}
